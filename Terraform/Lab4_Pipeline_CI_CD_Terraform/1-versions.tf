...
terraform {
  ...
  backend "azurerm" {
    resource_group_name  = "RG-AKSClusterKSO"         # mettre ici le nom du resource group de vos ressource
    storage_account_name = "terraformkso"      # mettre le nom du compte de stockage créer dans le lab 1
    ...
    sas_token = "sp=racwl&st=2022-06-23T14:35:47Z&se=2022-06-23T22:35:47Z&spr=https&sv=2021-06-08&sr=c&sig=VgcXYzBJSABNu2rRHLjb0yRGbkskjpri2TkEXCgcI1U%3D"
